...
**01-intro.pdf** - CIS194 完整 Lecture 1，涵盖类型基础、类型类、类型变量、Eq/Ord/Num/Show/Read 等

**十分钟学会 Haskell** - Haskell 语言快速入门，涵盖表达式、类型、列表、IO等基础内容

**llm-wiki** - Andrej Karpathy 提出的 LLM-Wiki 模式：让 AI 增量构建和维护持久化知识库，而非每次重新检索

**Real World Haskell** - 712页实战Haskell教材，涵盖基础到高级主题

**黑客新闻 (Hacker News)** - 技术新闻聚合网站，涵盖编程、AI，开源等领域热点

**LYAH 第二章** - Learn You A Haskell 入门教程，涵盖 ghci 基础、布尔运算、相等性判断
